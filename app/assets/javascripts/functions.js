$( document ).ready( function() {
    ...
    */                   
    ...
    $.martanianManageImages = function() {
        ...
        $( '.insurances-slider .images, .box-with-image-left .image' ).css({ 'width': width +'px', 'margin-left': - margin +'px' });
    ...
    */      
    ...
    $( window ).load( function() {
        ...
        $( '#quote-popup .quote-form .slider' ).each( function() {
    ...
    */            
    ...
    $( '#quote-popup #quote-popup-content .quote-form .quote-form-thanks .quote-form-thanks-content .quote-form-thanks-close' ).click( function() {
